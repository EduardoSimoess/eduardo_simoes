...
export default function Skills() {
    return (
        <div className="flex flex-col md:mt-44 text-blue-500 gap-5">
            <div className="flex flex-col items-center w-100 text-center">
                <h1 className="text-4xl md:text-6xl font-extrabold">Habilidades</h1>
            </div>
            <div className='flex md:flex-row flex-col flex-wrap gap-3 justify-center'>
                <div className='flex flex-col gap-1 px-10 py-8 border-4 rounded-sm border-white align-middle items-center'>
